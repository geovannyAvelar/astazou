...
class TransactionServiceTest {
  ...
  void calculateMonthBalance_returnsCorrectBalance() {
    when(repository.calculateIncomeByUsernameAndMonth("user", 3, 2025)).thenReturn(1000.0);
    when(repository.calculateExpenseByUsernameAndMonth("user", 3, 2025)).thenReturn(400.0);
  ...
  void getMonthlySummary_always12Months_andFillsZeroForMissing() {
    when(repository.getMonthlySummary("user", 2025)).thenReturn(List.of(new MonthlySummaryDto(3, 1000.0, 400.0)));
  ...
  void getMonthlySummary_allMonthsPresent_noGapFilling() {
    ...
    when(repository.getMonthlySummary("user", 2025)).thenReturn(rows);
  ...
  void getMonthlySummary_emptyRepositoryResult_returns12ZeroMonths() {
    when(repository.getMonthlySummary("user", 2025)).thenReturn(List.of());
